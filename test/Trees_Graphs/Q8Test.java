...
public class Q8Test {
    ...
    public void testFindFirstAncestor() throws Exception {
        assertEquals(new Integer(2), Q8.findCommonAncestor(node1, node7, node8).value);
        assertEquals(new Integer(1), Q8.findCommonAncestor(node1, node7, node6).value);
        assertEquals(new Integer(3), Q8.findCommonAncestor(node1, node3, node6).value);
    }
}
